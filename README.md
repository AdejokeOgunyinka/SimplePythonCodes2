...
![Quadratic Formula](assets/QuadraticFormula.png)

While writing the logic for this function, ensure to handle the zero division exception that may likely be raised when the value of argument `"a"` is zero 
